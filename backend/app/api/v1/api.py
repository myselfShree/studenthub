...
from app.api.v1.endpoints import health, auth, subjects, notes, tasks, habits, files, ai, resources, dashboard, journal
...
api_router.include_router(journal.router, prefix="/journal", tags=["Daily Journal"])
